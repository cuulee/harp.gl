...
/**
 * An accessor for all geometries in a tile. This class uses a client-provided
 * {@link ITileDataVisitor} to visit all objects, based on filtering options specified by both,
 * the `TileDataAccessor` and the visitor itself.
 */
