...
/**
 * `IPassManager` provides a base interface for {@link Pass} managers like
...
export interface IPassManager {
    ...
    /**
     * The resize method to extend in {@link Pass} implementations to resize the render targets
     * to match the size of the visible canvas. It should be called on resize events.
     *
