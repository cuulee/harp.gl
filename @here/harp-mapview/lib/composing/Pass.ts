...
export interface IPass {
    ...
    /**
     * The resize method to extend in {@link Pass} implementations. It resizes the render targets.
     * Call on resize events.
     *
    ...
    /**
     * The render method to extend in {@link Pass} implementations. This is the place where the
     * desired effects or render operations are executed.
     *
...
/**
 * The base class to extend for further passes in {@link MapView}, like the {@link MSAARenderPass},
 * possibly a text pass, an AO effect etc. `Pass` provides the core logic for both:
