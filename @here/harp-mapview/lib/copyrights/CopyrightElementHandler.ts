...
export class CopyrightElementHandler {
    /**
     * Install {@link CopyrightElementHandler} on DOM element and - optionally - attach to a
     * {@link MapView} instance.
     *
     * @param element HTML DOM element or a HTML DOM element id
     * @param mapView, optional, {@link attach} to this {@link MapView}
     */
     ...
     *
     * Note: Generally, the static {@link install} method can be used to create and attach a new
     * `CopyrightElementHandler` to a {@link MapView}
     *
     * @param element HTML DOM element or a HTML DOM element id
     * @param mapView optional, {@link attach} to this {@link MapView} instance
     */
    ...
    /**
     * Set {@link CopyrightInfo} defaults to be used in case {@link DataSource} does not provide
     * deatailed copyright information.
     *
    ...
    /**
     * Sets the {@link staticInfo} property.
     *
     ...
     *
     * This information is used when {@link DataSource} instances of given {@link MapView} do not
