...
export interface CopyrightInfo {
     ...
     *
     * Note: {@link DataSource} may return {@link CopyrightInfo} with only `id`, thus defining only
     * holder of copyright, however, valid attribution may require proper `label` and `link`.
     *
