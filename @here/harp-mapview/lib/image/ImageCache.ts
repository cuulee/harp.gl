...
/**
 * Combines an {@link ImageItem} with a list of {@link MapViews} that reference it.
 */
class ImageCacheItem {
     ...
     *
     * @param imageItem The {@link ImageItem} referenced by the associated {@link MapView}s
     *        instances.
...
export class ImageCache {
     ...
     * @param image {@link HTMLImageElement} to
     */
    private renderImage(
        imageItem: ImageItem,
