...
/**
 * {@link ExprPool} maintains a set of unique interned {@link Expr} objects.
 *
 * @hidden
 */
export class ExprPool implements ExprVisitor<Expr, void> {
    ...
    /**
     * Add `expr` to this {@link ExprPool} and return a unique {@link Expr}
     * object that is structurally equivalent to `expr`.
     *
     * @param expr The {@link Expr} to add to this {@link ExprPool}.
