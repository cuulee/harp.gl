...
export class QuadTree {
    ...
    /**
     * Visits this `QuadTree` and invoke the given accept method with the current {@link TileKey}
     ...
     * ```
     *
     * @param accept A function that takes a {@link TileKey} and its bounding box in geo coordinates
